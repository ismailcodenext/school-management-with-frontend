  ...
  <!-- Hero Start -->
  <section id="institute_gallery_hero">
    <div class="container">
      <div class="institute_gallery_hero_content">
        <h1>ইনস্টিটিউট গ্যালারী</h1>
      </div>
      <div class="institute_gallery_hero_img_line">
  ...
  <!-- Galler Heading Start-->
  <section id="heading_btn">
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-12">
          ...
          <div class="product_menu_tabs">
            <div class="product_tab_arrow_icon">
              <i id="left" class="fa-solid fa-chevron-left"></i>
            </div>
            <ul class="product_menu_item_tab">
              <li class="product_menu_tab_btn active">সকল</li>
              <li class="product_menu_tab_btn">সাংস্কৃতিক অনুষ্ঠান</li>
              <li class="product_menu_tab_btn">ক্রীড়া দিবস</li>
              <li class="product_menu_tab_btn">বাগান করা</li>
              <li class="product_menu_tab_btn">পুরস্কার বিতরণী অনুষ্ঠান</li>
              <li class="product_menu_tab_btn">সাংস্কৃতিক অনুষ্ঠান</li>
              <li class="product_menu_tab_btn">ক্রীড়া দিবস</li>
              <li class="product_menu_tab_btn">বাগান করা</li>
              <li class="product_menu_tab_btn">পুরস্কার বিতরণী অনুষ্ঠান</li>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-3">
                    ...
                    <a>
                      <img src="{{asset('front-end/assets/image/institution_gallery_card_img_01.png')}}" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="{{asset('front-end/assets/image/institution_gallery_card_img_01.png')}}" data-lightbox="models"
                          data-title="caption1">
                ...
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-3">
                    ...
                    <a>
                      <img src="{{asset('front-end/assets/image/institution_gallery_card_img_02.png')}}" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="{{asset('front-end/assets/image/institution_gallery_card_img_02.png')}}" data-lightbox="models"
                          data-title="caption1">
                          <svg width="38" height="26" viewBox="0 0 38 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-3">
                    ...
                    <a>
                      <img src="{{asset('front-end/assets/image/institution_gallery_card_img_03.png')}}" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="{{asset('front-end/assets/image/institution_gallery_card_img_03.png')}}" data-lightbox="models"
                          data-title="caption1">
                          <svg width="38" height="26" viewBox="0 0 38 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-4">

                    <a>
                      <img src="{{asset('front-end/assets/image/institution_gallery_card_img_04.png')}}" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="{{asset('front-end/assets/image/institution_gallery_card_img_04.png')}}" data-lightbox="models"
                          data-title="caption1">
                          <svg width="38" height="26" viewBox="0 0 38 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-4">
                    ...
                    <a>
                      <img src="./assets/image/institution_gallery_card_img_02.png" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="./assets/image/institution_gallery_card_img_02.png" data-lightbox="models"
                          data-title="caption1">
                          <svg width="38" height="26" viewBox="0 0 38 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-4">
                    ...
                    <a>
                      <img src="./assets/image/institution_gallery_card_img_03.png" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="./assets/image/institution_gallery_card_img_03.png" data-lightbox="models"
                          data-title="caption1">
                          <svg width="38" height="26" viewBox="0 0 38 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-4">
                    ...
                    <a>
                      <img src="./assets/image/institution_gallery_card_img_04.png" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="./assets/image/institution_gallery_card_img_04.png" data-lightbox="models"
                          data-title="caption1">
                          <svg width="38" height="26" viewBox="0 0 38 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="col-lg-4">
                  <div class="institution_gallery_content_img mt-3">
                    ...
                    <a>
                      <img src="./assets/image/institution_gallery_card_img_01.png" alt="">
                    </a>
                    <div class="institution_gallery_content_img_overlay">
                      <h2>স্কুলের প্রথম দিন।</h2>
                      <div class="overlay_btn">
                        <a href="./assets/image/institution_gallery_card_img_01.png" data-lightbox="models"
                          data-title="caption1">
                          <svg width="38" height="26" viewBox="0 0 38 26" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
